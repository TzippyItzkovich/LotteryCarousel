    ...
    return (
      <div className="blue-side">
        ...
        <div className="right-side">
          <CountdownTimer drawTime={lottery.drawTime} /> {/* Countdown timer */}
      ...
      <div className="result-side">
        ...
        <div className="result-numbers">
          {lottery.resultNumbers.slice(0, 8).map((number, index) => (
            <span key={index} className="result-ball">
              {number}
            </span>
          ))}
        </div>
  ...
  return (
    ...
    >
      <div className="card-inner">
        <div className="card-front">{renderBlueSide()}</div>
        <div className="card-back">{renderResultSide()}</div>
      </div>
    </div>
  );
};
